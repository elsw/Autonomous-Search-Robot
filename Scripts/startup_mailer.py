...
gmail_user = 'stevewithersdev@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'animation4664' # Gmail password.
smtpserver = smtplib.SMTP('smtp.gmail.com', 587) # Server to use. 465
